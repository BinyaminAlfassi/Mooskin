...
class NotesListViewController: UIViewController, UITableViewDataSource {
    ...
    fileprivate func setupFetchedResultsController() {
        ...
        fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: dataController.viewContext, sectionNameKeyPath: nil, cacheName: "notesOf\(String(describing: notebook.name))")
